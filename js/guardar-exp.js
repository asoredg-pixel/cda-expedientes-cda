...
function guardarExpCore(stayOnForm){
  ...
  let data={
    ...
    _qd_nombre:gv('fld__qd_nombre'),_qd_identificacion:(typeof formatIdentDisplay==='function'?formatIdentDisplay(gv('fld__qd_identificacion')):gv('fld__qd_identificacion')),_qd_correo:gv('fld__qd_correo'),_qd_telefono:gv('fld__qd_telefono'),...getDir('qd'),
    _pi_tipo_persona:gv('fld__pi_tipo_persona')||'natural',
    _pi_nombre:gv('fld__pi_nombre'),_pi_identificacion:(typeof formatIdentDisplay==='function'?formatIdentDisplay(gv('fld__pi_identificacion')):gv('fld__pi_identificacion')),_pi_correo:gv('fld__pi_correo'),_pi_telefono:gv('fld__pi_telefono'),...getDir('pi'),
    _pi_rep_nombre:gv('fld__pi_rep_nombre'),_pi_rep_identificacion:(typeof formatIdentDisplay==='function'?formatIdentDisplay(gv('fld__pi_rep_identificacion')):gv('fld__pi_rep_identificacion')),_pi_rep_correo:gv('fld__pi_rep_correo'),_pi_rep_telefono:gv('fld__pi_rep_telefono'),
    _pi_empresa:gv('fld__pi_empresa'),_pi_nit:(typeof formatNitDisplay==='function'?formatNitDisplay(gv('fld__pi_nit')):gv('fld__pi_nit')),_pi_correo_emp:gv('fld__pi_correo_emp'),_pi_telefono_emp:gv('fld__pi_telefono_emp'),...getDir('pi_emp'),
    _tipo_persona:gv('fld__tipo_persona')||'natural',
    _pn_nombre:gv('fld__pn_nombre'),_pn_identificacion:(typeof formatIdentDisplay==='function'?formatIdentDisplay(gv('fld__pn_identificacion')):gv('fld__pn_identificacion')),_pn_correo:gv('fld__pn_correo'),_pn_telefono:gv('fld__pn_telefono'),
    ...getDir('pn'),
    ...
    _pj_rep_nombre:gv('fld__pj_rep_nombre'),_pj_rep_identificacion:(typeof formatIdentDisplay==='function'?formatIdentDisplay(gv('fld__pj_rep_identificacion')):gv('fld__pj_rep_identificacion')),_pj_rep_correo:gv('fld__pj_rep_correo'),_pj_rep_telefono:gv('fld__pj_rep_telefono'),
    _pj_empresa:gv('fld__pj_empresa'),_pj_nit:(typeof formatNitDisplay==='function'?formatNitDisplay(gv('fld__pj_nit')):gv('fld__pj_nit')),_pj_correo:gv('fld__pj_correo'),_pj_telefono:gv('fld__pj_telefono'),...getDir('pj'),
    _apoderado:document.getElementById('fld__apoderado')?document.getElementById('fld__apoderado').checked:false,
    _apo_nombre:gv('fld__apo_nombre'),_apo_identificacion:(typeof formatIdentDisplay==='function'?formatIdentDisplay(gv('fld__apo_identificacion')):gv('fld__apo_identificacion')),_apo_correo:gv('fld__apo_correo'),_apo_telefono:gv('fld__apo_telefono'),...getDir('apo'),
